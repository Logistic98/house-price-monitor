            ...
            <div class="search" style="display: inline-block" :rules="rules">
                <el-form ref="search" :model="search" :rules="rules" :inline="true">
                    ...
                    <el-form-item label="" prop="endPrice">
                        <el-input v-model="search.endPrice" style="width:150px" placeholder="请输入最高价格" @change="handleEndPriceChange"></el-input> 万/套
                    </el-form-item>
                    <el-form-item label="">               
                    ...
                    <el-form-item label="">
                        朝向：<el-input v-model="search.direction" style="width:150px" placeholder="请输入朝向"></el-input>
                    </el-form-item>
                    <el-form-item label="">
                        装修：<el-input v-model="search.furnish" style="width:150px" placeholder="请输入装修"></el-input>
                    </el-form-item>
...
<script>
import { getTableData } from '@/api/secondHand'
    ...
    methods: {
        ...
        labelInit(){
            this.tableData.tableLabel = [
                ...
                {prop:'descs',title:'房源描述', width:200, tooltip:true},
                {prop:'layout',title:'布局',width:100, tooltip:true},
                {prop:'size',title:'大小',width:100, tooltip:true},
                {prop:'direction',title:'朝向',width:100, tooltip:true},
                {prop:'furnish',title:'装修',width:100, tooltip:true},
                {prop:'floor',title:'楼层',width:150, tooltip:true},
                {prop:'type',title:'房屋类型',width:100, tooltip:true},
                {prop:'price',title:'价格',width:100, tooltip:true},
                {prop:'time',title:'抓取时间',width:160, tooltip:true},
