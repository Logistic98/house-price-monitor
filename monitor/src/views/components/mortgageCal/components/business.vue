<template>
    <div class="home">
        <el-form ref="search" :inline="true" :rules="rules" :model="search">
            <el-form-item label="" prop="loan">
                贷款金额：<el-input v-model="search.loan" style="width:150px" placeholder="请输入贷款金额"></el-input> 万
            </el-form-item>
            <el-form-item label="" prop="year">
                贷款年限：<el-input v-model="search.year" style="width:150px" placeholder="请输入贷款年限"></el-input> 年
            </el-form-item>
            <el-form-item label="" prop="rate">
                利率：<el-select v-model="search.rate" filterable allow-create default-first-option placeholder="请选择或输入利率">
        ...
        <el-row :gutter="20"> 
            <el-col :span="12"> 
                <div class="grid-content bg-purple">
                    ...
                    <el-col :span="24">
                        <div ref="fixPieChart" class="grid-content bg-purple-light" style="width: 675px;height:320px;"></div>
                    </el-col>
                    <el-col :span="24">
                        <div class="grid-content bg-purple-light">
            ...
            <el-col :span="12">
                <div class="grid-content bg-purple">
                    ...
                    <el-col :span="24">
                        <div ref="CapitalPieChart" class="grid-content bg-purple-light" style="width: 675px;height:320px;"></div>
                    </el-col>
                    <el-col :span="24">
                        <div class="grid-content bg-purple-light">
                            <el-descriptions title="计算结果">
...
export default {
    ...
    methods: {
        ...
        calculateData(search){
            const loan = Number.parseFloat(search.loan);
            const year = Number.parseFloat(search.year);
            const rate = Number.parseFloat(search.rate);
